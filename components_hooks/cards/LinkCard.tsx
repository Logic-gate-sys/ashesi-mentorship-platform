...
export function LinkCard({to}: {to: string}){
    ...
    >
      ...
      <section className="flex flex-col gap-4">
          <div className="w-full flex flex-row items-start gap-4 p-4 pl-3.5 pr-3.5 bg-white rounded-2xl shadow-inner">
            ...
            <div className="flex-1 flex flex-col gap-1.5 justify-center">
              ...
              {/* MEETING LINK */}
              <Link href="mentees/request" className={`flex flex-row items-center gap-1.5 group`}>
