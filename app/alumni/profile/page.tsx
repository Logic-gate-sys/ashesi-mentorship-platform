...
import mentorImg from '@/public/assets/Kwesi Mensah.jpeg'

export default function AlumniProfile() {
  return (
    <div className="w-full min-h-screen bg-white p-12 overflow-y-auto">
        ...
        <div className="col-span-12 lg:col-span-7 grid grid-rows-auto gap-8">
          ...
          <div className="bg-[#fffafa] rounded-[48px] p-10 flex items-center gap-8 shadow-sm border border-red-50 relative group">
            <div className="relative">
              <Image src={mentorImg} alt="Kwame Mensah" className="w-32 h-32 rounded-[40px] object-cover border-4 border-white shadow-xl" width={128} height={128} />
