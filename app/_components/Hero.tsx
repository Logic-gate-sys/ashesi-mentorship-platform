...
export function Hero(){
    return (
         <section className="bg-gradient-to-br from-primary via-primary-dark to-sidebar px-10 pt-24 pb-20 relative overflow-hidden">
        {/* Decorative rings */}
        <div className="absolute -top-32 -right-32 w-[520px] h-[520px] rounded-full border border-primary-light/20 pointer-events-none" />
        <div className="absolute -top-16 -right-16 w-85 h-85 rounded-full border border-primary-light/10 pointer-events-none" />
        <div className="absolute -bottom-20 -left-20 w-[380px] h-[380px] rounded-full bg-primary/5 blur-[70px] pointer-events-none" />
        ...
        <div className="max-w-[820px] mx-auto text-center relative">
          ...
          <h1 className="font-display font-extrabold text-white leading-[1.1] tracking-[-0.03em] text-[clamp(38px,6vw,68px)] mb-6">
            ...
            <span className="text-primary">built for Ashesi</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <Link
              ...
              className="btn btn-primary h-[50px] px-8 text-[15px] w-full sm:w-auto"
            >
              I&apos;m a student — find a mentor →
            </Link>
            <Link
              href="/register/alumni"
              className="btn btn-secondary-inverse h-[50px] px-8 text-[15px] w-full sm:w-auto"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-16 pt-14 border-t border-white/8">
            {stats.map(s => (
              <div key={s.label} className="text-center">
                <div className="font-display font-bold text-[30px] text-primary tracking-tight">{s.value}</div>
